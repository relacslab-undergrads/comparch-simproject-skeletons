...
"""
pin = '/hdd1/hynix-cxl/pin-3.13-98189-g60a6ef199-gcc-linux/pin' ### FIXME
...
def pinpoint_tracegen(args):
  ...
  pin_dir        = '/hdd1/hynix-cxl/pin-3.13-98189-g60a6ef199-gcc-linux' ### FIXME
  ...
  script_file.write('os.system(\'%s -t %s -skipinst %s -max %s -tracename %s -dump 1 -dump_file %s.dump -- %s\' %s)\n\n'
...
def main():
  ...
  ## normal mode
    ...
    os.system('%s -t %s -thread %s -max %s -skipinst %s -- %s' % (pin, tracegen, args['-t'], args['-n'], args['-s'], args['-c']))
